...
?>
 ...
 <li>
                ...
                <li>
                 ...
                 <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">DELIVERY BOYS</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="view_deli.php">VIEW</a></li>
                        <li><a href="add_deli.php">ADD</a></li>
                        <li><a href="edit_deli.php">EDIT</a></li>
